    ...
    return (
        <div className='profile-page'>
            ...
            <div className='profile-pic-container'>
                <Avatar alt="Profile Picture" src={dp} sx={{ width: 175, height: 175, bgcolor: deepOrange[500], display: 'flex', justifyContent: 'center', alignItems: 'center' }}><GroupsIcon sx={{ width: 42.5, height: 42.5, position: 'relative', bottom: '1.5%' }} /></Avatar>
            </div>
